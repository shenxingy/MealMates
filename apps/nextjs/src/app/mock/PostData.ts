...
export class PostData {
  private static postMockData: Post[] = [
    {
      ...
      image:
        "https://rcucryvgjbthzoirnzam.supabase.co/storage/v1/object/public/Post/steak.jpg",
      user: "user0",
    ...
    },
    {
      ...
      image:
        "https://rcucryvgjbthzoirnzam.supabase.co/storage/v1/object/public/Post/curry.jpg",
      user: "user3",
    ...
    },
    {
      ...
      content: "",
      image:
        "https://rcucryvgjbthzoirnzam.supabase.co/storage/v1/object/public/Post/hotpot.webp",
      user: "user2",
  ...
  public static dislikePost(idx: number): boolean {
    if (!PostData.postMockData[idx]?.liked) {
      return false;
    }
    PostData.postMockData[idx].likes--;
  ...
  public static dislikeComment(postId: number, commentId: number): boolean {
    if (!PostData.postCommentsMockData[postId]?.[commentId]?.liked) {
      return false;
    }
    PostData.postCommentsMockData[postId][commentId].likes--;
